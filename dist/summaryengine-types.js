var summaryengine_types = (function (exports) {
    ...
    /* src/types/Types.svelte generated by Svelte v3.52.0 */
    	...
    	return {
    		...
    		p(new_ctx, dirty) {
    			...
    			if (current_block_type === (current_block_type = select_block_type(ctx)) && if_block0) {
    				...
    				if (if_block0) {
    					if_block0.c();
    					if_block0.m(t54.parentNode, t54);
    				}
    			}
    			...
    			if (show_if) {
    				if (if_block1) {
    					...
    					if_block1.c();
    					if_block1.m(t55.parentNode, t55);
    				}
    			} else if (if_block1) {
    				if_block1.d(1);
    				if_block1 = null;
    			...
    			if (/*deleting*/ ctx[4]) {
    				if (if_block2) ; else {
    					...
    					if_block2.c();
    					if_block2.m(t56.parentNode, t56);
    				}
    			} else if (if_block2) {
    				if_block2.d(1);
    				if_block2 = null;
    ...
    // (182:8) {#if (Number(type.ID) !== 1) && (!deleting)}
