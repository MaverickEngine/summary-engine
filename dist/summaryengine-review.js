var summaryengine_review = (function () {
    ...
    function create_else_block_2(ctx) {
    	...
    	return {
    		c() {
    			input = element("input");
    			attr(input, "class", "summaryengine-button svelte-1k28cfn");
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(input, "click", /*summarise*/ ctx[6]);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_if_block_5(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			attr(div, "class", "summaryengine-summarise__summary svelte-1k28cfn");
    		},
    		m(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	let div;
    	let if_block = /*summary*/ ctx[0]?.summary && create_if_block_1(ctx);
    ...
    // (99:12) {#if summary?.summary}
    function create_if_block_1(ctx) {
    	let t;
    	let if_block1_anchor;
    	let if_block0 = !/*approved*/ ctx[5] && !/*disapproving*/ ctx[3] && create_if_block_3(ctx);
    ...
    // (100:16) {#if (!approved && !disapproving)}
    function create_if_block_3(ctx) {
    	let if_block_anchor;

    	function select_block_type_1(ctx, dirty) {
    		if (/*approving*/ ctx[4]) return create_if_block_4;
    ...
    function create_else_block_1(ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(input, "click", /*approve*/ ctx[7]);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_else_block(ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(input, "click", /*disapprove*/ ctx[8]);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_fragment$4(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*summary*/ ctx[0].summary) return create_if_block_5;
    		if (/*summarising*/ ctx[2]) return create_if_block_6;
    		return create_else_block_2;
    	}

    	let current_block_type = select_block_type(ctx);
    	let if_block0 = current_block_type(ctx);
    	let if_block1 = /*hovering*/ ctx[1] && create_if_block$1(ctx);
    	...
    	return {
    		c() {
    			...
    			attr(div, "class", "summaryengine-summarise svelte-1k28cfn");
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		try {
    			...
    			console.error(e); // console.log(summary);
    		}
    	});

    	async function summarise() {
    		try {
    			$$invalidate(2, summarising = true);
    			...
    			$$invalidate(2, summarising = false);
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('type_id' in $$props) $$invalidate(9, type_id = $$props.type_id);
    		if ('post_id' in $$props) $$invalidate(10, post_id = $$props.post_id);
    	};
    ...
    class Summarise extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { summary: 0, type_id: 9, post_id: 10 });
    	}
    }
    ...
    // (100:16) {#each $types as type}
    function create_each_block_2(ctx) {
    	let th;
    	let t_value = /*type*/ ctx[14].name + "";
    	let t;
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if (dirty & /*$types*/ 2 && t_value !== (t_value = /*type*/ ctx[14].name + "")) set_data(t, t_value);
    		},
    		d(detaching) {
    ...
    function create_each_block_1(ctx) {
    	...
    	summarise = new Summarise({
    			props: {
    				type_id: /*type*/ ctx[14].ID,
    				post_id: /*post*/ ctx[11].id,
    				summary: /*post*/ ctx[11].summaries[/*type*/ ctx[14].slug]
    			}
    		});
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*$types*/ 2) summarise_changes.type_id = /*type*/ ctx[14].ID;
    			if (dirty & /*$posts*/ 1) summarise_changes.post_id = /*post*/ ctx[11].id;
    			if (dirty & /*$posts, $types*/ 3) summarise_changes.summary = /*post*/ ctx[11].summaries[/*type*/ ctx[14].slug];
    ...
    // (118:24) {#if !checkSummariesSet(post)}
    function create_if_block(ctx) {
    	...
    	function click_handler() {
    		return /*click_handler*/ ctx[6](/*post*/ ctx[11]);
    	}
    ...
    // (107:12) {#each $posts as post}
    function create_each_block(ctx) {
    	let tr;
    	let td0;
    	let a;
    	let t0_value = /*post*/ ctx[11].post_title + "";
    	let t0;
    	let a_href_value;
    	let t1;
    	let td1;
    	let t2_value = /*post*/ ctx[11].post_date + "";
    	let t2;
    	let t3;
    	let td2;
    	let t4_value = /*post*/ ctx[11].post_author + "";
    	let t4;
    	let t5;
    	let t6;
    	let td3;
    	let show_if = !checkSummariesSet(/*post*/ ctx[11]);
    	let t7;
    	let current;
    	let each_value_1 = /*$types*/ ctx[1];
    	let each_blocks = [];
    	...
    	return {
    		c() {
    			...
    			if (if_block) if_block.c();
    			t7 = space();
    			attr(a, "href", a_href_value = /*post*/ ctx[11].permalink);
    		},
    		m(target, anchor) {
    		...
    		p(ctx, dirty) {
    			if ((!current || dirty & /*$posts*/ 1) && t0_value !== (t0_value = /*post*/ ctx[11].post_title + "")) set_data(t0, t0_value);

    			if (!current || dirty & /*$posts*/ 1 && a_href_value !== (a_href_value = /*post*/ ctx[11].permalink)) {
    				attr(a, "href", a_href_value);
    			}

    			if ((!current || dirty & /*$posts*/ 1) && t2_value !== (t2_value = /*post*/ ctx[11].post_date + "")) set_data(t2, t2_value);
    			if ((!current || dirty & /*$posts*/ 1) && t4_value !== (t4_value = /*post*/ ctx[11].post_author + "")) set_data(t4, t4_value);

    			if (dirty & /*$types, $posts*/ 3) {
    				each_value_1 = /*$types*/ ctx[1];
    				let i;
    			...
    			if (dirty & /*$posts*/ 1) show_if = !checkSummariesSet(/*post*/ ctx[11]);
    ...
    function create_fragment(ctx) {
    	...
    	let current;
    	dates = new Dates({});
    	dates.$on("click", /*reset*/ ctx[5]);
    	search_1 = new Search({});
    	search_1.$on("search", /*reset*/ ctx[5]);
    	pages = new Pages({ props: { per_page } });
    	pages.$on("click", /*getPosts*/ ctx[3]);
    	pages.$on("change", /*getPosts*/ ctx[3]);
    	let each_value_2 = /*$types*/ ctx[1];
    	let each_blocks_1 = [];
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "svelte-1n6yefi");
    			attr(div1, "id", "summaryEngineSearchContainer");
    			attr(div1, "class", "summary-engine-margin-bottom-5 svelte-1n6yefi");
    			attr(div2, "id", "summaryEnginePagesContainer");
    			attr(div3, "id", "summaryEngineMetaBlockSummariseButtonContainerRight");
    			attr(div3, "class", "svelte-1n6yefi");
    			attr(div4, "id", "summaryEngineMetaBlockSummariseButtonContainer");
    			attr(div4, "class", "svelte-1n6yefi");
    			attr(th0, "class", "summaryengine-small-col svelte-1n6yefi");
    			attr(th1, "class", "summaryengine-small-col svelte-1n6yefi");
    			attr(th2, "class", "summaryengine-small-col svelte-1n6yefi");
    			attr(table, "class", "wp-list-table widefat fixed striped table-view-list svelte-1n6yefi");
    			toggle_class(table, "loading", /*$loading*/ ctx[2]);
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*generateAllSummaries, $posts, checkSummariesSet, $types*/ 19) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, search, $$value => $$invalidate(8, $search = $$value));
    	component_subscribe($$self, selected_date, $$value => $$invalidate(9, $selected_date = $$value));
    	...
    	return [$posts, $types, $loading, getPosts, generateAllSummaries, reset, click_handler];
    }
