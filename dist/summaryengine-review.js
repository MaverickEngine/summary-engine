var summaryengine_review = (function () {
    ...
    function create_else_block_1(ctx) {
    	...
    	return {
    		c() {
    			input = element("input");
    			attr(input, "class", "summaryengine-button button svelte-26qe61");
    ...
    function create_if_block_6(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			attr(div, "class", "summaryengine-summarise__summary svelte-26qe61");
    		},
    		m(target, anchor) {
    ...
    // (102:4) {#if hovering || just_summarised}
    function create_if_block$1(ctx) {
    	let div;
    	let if_block = /*summary*/ ctx[0]?.summary && create_if_block_1$1(ctx);
    ...
    // (105:12) {#if summary?.summary}
    function create_if_block_1$1(ctx) {
    	let t;
    	let if_block1_anchor;
    	let if_block0 = !/*approved*/ ctx[4] && !/*disapproving*/ ctx[2] && create_if_block_4(ctx);

    	function select_block_type_2(ctx, dirty) {
    		if (/*disapproving*/ ctx[2]) return create_if_block_2;
    		if (!/*approving*/ ctx[3]) return create_if_block_3;
    	}
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if (!/*approved*/ ctx[4] && !/*disapproving*/ ctx[2]) {
    				if (if_block0) {
    ...
    // (106:16) {#if (!approved && !disapproving)}
    function create_if_block_4(ctx) {
    	let if_block_anchor;

    	function select_block_type_1(ctx, dirty) {
    		if (/*approving*/ ctx[3]) return create_if_block_5;
    ...
    function create_fragment$4(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		...
    		if (/*summary*/ ctx[0].summarising) return create_if_block_7;
    		return create_else_block_1;
    	}

    	let current_block_type = select_block_type(ctx);
    	let if_block0 = current_block_type(ctx);
    	let if_block1 = (/*hovering*/ ctx[1] || /*just_summarised*/ ctx[5]) && create_if_block$1(ctx);
    	...
    	return {
    		c() {
    			...
    			t = space();
    			if (if_block1) if_block1.c();
    			attr(div, "class", "summaryengine-summarise svelte-26qe61");
    			toggle_class(div, "is_hovering", /*hovering*/ ctx[1]);
    			toggle_class(div, "just_summarised", /*just_summarised*/ ctx[5]);
    		...
    		p(ctx, [dirty]) {
    			...
    			if (/*hovering*/ ctx[1] || /*just_summarised*/ ctx[5]) {
    				if (if_block1) {
    					if_block1.p(ctx, dirty);
    				} else {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	async function summarise() {
    		try {
    			...
    			$$invalidate(0, summary.summarising = false, summary);
    			$$invalidate(4, approved = false);
    			$$invalidate(5, just_summarised = true);
    		} catch(err) {
    			console.error(err); // disapproved = false;
    	...
    	async function disapprove() {
    		try {
    			$$invalidate(2, disapproving = true);
    			await apiPost(`/summaryengine/v1/rate/${summary.summary_id}`, { rating: -1 });
    			await summarise();
    			$$invalidate(2, disapproving = false);
    			$$invalidate(0, summary.summary_details.rating = 0, summary);
    			$$invalidate(5, just_summarised = false);
    			$$invalidate(4, approved = false);
    		} catch(err) {
